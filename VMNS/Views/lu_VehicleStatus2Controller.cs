...
namespace VMNS.Views
{
    public class lu_VehicleStatus2Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public lu_VehicleStatus2Controller(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: lu_VehicleStatus2
        ...
        // GET: lu_VehicleStatus2/Details/5
        ...
        // GET: lu_VehicleStatus2/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: lu_VehicleStatus2/Create
        ...
        // GET: lu_VehicleStatus2/Delete/5
        ...
        // POST: lu_VehicleStatus2/Delete/5
